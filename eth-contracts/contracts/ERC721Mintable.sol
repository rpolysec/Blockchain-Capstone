...
contract Pausable is Ownable {
    ...
    */
    ...
    /**
    * 'whenNotPaused': throw if the contract is paused
    */
    ...
    /**
    * 'paused': throw if the contract is not paused
    */
    modifier paused()
    {
        require(_paused, "Contract must not be paused to proceed");
        _;
    }
...
contract ERC165 {
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        require(interfaceId != 0xffffffff, 'Interface id can not be 0xffffffff');
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=ownerOf(tokenId),'Cannot approve owner');
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender,'sender can not approve itself');
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), 'Must be approved or contract owner');
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), 'Error checkOnERC721Received');
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        _mint(to, tokenId);
        _ownedTokensCount[address].increcement();
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId)==from,'Only the owner of the token can transfer');
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (uint256) {
        require(index < balanceOf(owner), 'index must be smaller owner balance');
    ...
    function tokenByIndex(uint256 index) public view returns (uint256) {
        require(index < totalSupply(), 'index must be less then total supply');
